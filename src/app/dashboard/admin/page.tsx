...
export default async function AdminDashboard() {
  ...
  const [documents, users, professionals, clients, jobs, reviews, reports, disputes, payments, auditLogs, registeredUsers, loginAttempts] = await Promise.all([
